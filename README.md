...
- [Development](#development)
  ...
  - [Create the SQL View](#create-sql-view)
- [Testing](#testing)
...
- [Recommendations](#recommendation)
  ...
  - [Potential Courses of Actions](#-potential-actionos)
...
1. Which 3 channels have uploaded the most videos?
...
6. Who are the top 10 YouTubers with the most subscribers?
...
We provide an initial idea of how the dashboard should look like using [mokkup.ai](https://www.mokkup.ai/)
...
|Python    | Gathering adittional data from the YouTube API      |
...
In this stage we scan  what's in the data looking for errors, inconsistencies, bugs, weird and corrupted characters, etc.

After the initial observation of our dataset, our conclusions are:
...
```
## Testing 
- What data quality and validation checks were created ?
